...
{	
	...
	{			
		...
		cmd /c cscript.exe _powerup\cmd.js $PSScriptRoot\psexec.exe $server['server.name'] /accepteula -w $fullLocalReleaseWorkingFolder $batchFile $deploymentEnvironment $tasks
	}
}
